...
const Sidebar = () => {
  ...
  return (
    <div className={sidebarClassNames}>
      <div className='flex h-[100%] x-full flex-col justify-start'>
        {/* Top LOGO */}
        ...
        {/* TEAM */}
        <div className='flex items-center gap-5 boder-y-[1,5px] border-gray-200 px-8 py-4 dark:border-gray-700 '>
